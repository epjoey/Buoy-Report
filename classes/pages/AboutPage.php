...
class AboutPage extends GeneralPage {
	...
	public function renderBodyContent() {
		...
		<div>
			...
			<span class="border"></span>
			<p class="joey">Buoy Report is designed and developed by me, aka Joey Hodara, a San Francisco web designer from Maui, Hawaii. This project was initially designed so that I could gain a better understanding of the complexity of Ocean Beach, SF, so I can surf it better.</p>
			<span class="border"></span>
