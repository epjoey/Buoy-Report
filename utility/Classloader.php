...
class Classloader {
    ...
    static protected $classloader_map = array(
        ...
        "MobileImageProcessPage" =>     "/view/templates/pages/MobileImageProcessPage.php",
